      ...
      <div className="notifications-filter__side">
        <div className="notifications-filter__input-box">
          <input
            type="text"
            name={"search"}
            onInput={changeFormHandler}
            className="notifications-filter__input"
            placeholder={"Поиск"}
          />
          <button
            onClick={formSubmitHandler}
            className="notifications-filter__submit"
          >
            <svg
              width="18"
              height="18"
        ...
        <button
          ...
          className="notifications-filter__item"
        >
          <svg
            width="18"
            height="18"
            ...
            <div className="filter">
              <div className="filter__items">
                <Select
                  ...
                  name={"project_type"} // The name of the select...
                  items={[
                    {
                      name: "Конкурс",
                      value: "CONTEST",
                ...
                {childrenActivity && childrenActivity.length > 0 && (
                  <Select
                    ...
                    selectClass={"filter__select"}
                    onSelect={changeFormHandler} // Callback on select...
                    name={"child_fields_of_activity"} // The name of the select...
                    items={[
                      ...childrenActivity.map((childActivity) => {
                        return {
                          name: childActivity.name,
                          value: childActivity.id,
                        };
                      }),
                    ]} // Array of the select's els in format {name: "", value: ""}...
                  />
